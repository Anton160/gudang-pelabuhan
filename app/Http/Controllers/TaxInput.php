...
class TaxInput extends Controller
{
    public function taxView(){
        return view('input.Tax', [
            'taxs' => Tax::all()

        ]);
    }
    public function taxInput(Request $request){
        ...
        return redirect('/Tax/input')->with('tax', 'data added successfully');
    ...
    public function download(){
        ...
        $sheet->setCellValue('D1', 'Expenses');
        ...
        foreach ($taxs as $tax) {
            ...
            $sheet->setCellValue('D' . $row, $tax['tax_name']);
