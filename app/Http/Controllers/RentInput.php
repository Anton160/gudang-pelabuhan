...
use App\Models\Warehouse_rent;
use Illuminate\Http\Request;
use PhpOffice\PhpSpreadsheet\Spreadsheet;
use PhpOffice\PhpSpreadsheet\Writer\Xlsx;

class RentInput extends Controller
{
    public function rentView(){
        return view('input.Rent', [
            'taxs' => Warehouse_rent::all()

        ]);
    }
    public function rentInput(Request $request){
        ...
        Warehouse_rent::create($tax);
        Income::create($tax);
        Comment::create($tax);
        Document::create($tax);
        
        return redirect('/Rent/input')->with('tax', 'data added successfully');
